...
export const FOSSIL_CANONICAL: Record<string, string> = {
  ...
  ammonites: 'ammonite',
  ammonite: 'ammonite',
  ammonitique: 'ammonite',
  goniatites: 'goniatite',
  goniatite: 'goniatite',
  hildoceras: 'hildoceras',
  harpoceras: 'harpoceras',
  lytoceras: 'lytoceras',
  arnioceras: 'arnioceras',
  baculites: 'baculite',
  scaphites: 'scaphite',
  orthocères: 'orthocère',
  orthoceres: 'orthocère',
  cardioceras: 'cardioceras',
  nautiles: 'nautile',
  nautile: 'nautile',
  céphalopodes: 'céphalopode',
  cephalopodes: 'céphalopode',
  // belemnites
  bélemnites: 'bélemnite',
  bélemnite: 'bélemnite',
  belemnites: 'bélemnite',
  belemnite: 'bélemnite',
  // echinoderms
  échinodermes: 'échinoderme',
  echinodermes: 'échinoderme',
  oursins: 'oursin',
  oursin: 'oursin',
  crinoïdes: 'crinoïde',
  crinoides: 'crinoïde',
  ...
  térébratules: 'térébratule',
  terebratules: 'térébratule',
  térébratule: 'térébratule',
  terebratule: 'térébratule',
  rhynchonelles: 'rhynchonelle',
  rhynchonelle: 'rhynchonelle',
  ...
  bivalves: 'bivalve',
  bivalve: 'bivalve',
  lamellibranches: 'lamellibranche',
  lamellibranche: 'lamellibranche',
  pélécypodes: 'pélécypode',
  pelecypodes: 'pélécypode',
  huîtres: 'huître',
  huître: 'huître',
  huitres: 'huître',
  huitre: 'huître',
  ...
  ostrea: 'ostrea',
  pecten: 'pecten',
  pectinidés: 'pectinidé',
  pectinides: 'pectinidé',
  plicatules: 'plicatule',
  trigonies: 'trigonie',
  trigonia: 'trigonia',
  inocérames: 'inocérame',
  inocerames: 'inocérame',
  inoceramus: 'inoceramus',
  // gastropods
  gastéropodes: 'gastéropode',
  gasteropodes: 'gastéropode',
  gastropodes: 'gastéropode',
  cérithes: 'cérithe',
  cerithes: 'cérithe',
  cérithe: 'cérithe',
  cerithe: 'cérithe',
  turritelles: 'turritelle',
  ...
  rudistes: 'rudiste',
  rudiste: 'rudiste',
  hippurites: 'hippurite',
  toucasia: 'toucasia',
  caprines: 'caprine',
  radiolites: 'radiolite',
  // corals
  coraux: 'corail',
  corail: 'corail',
  coralien: 'corail',
  ...
  stromatoporidés: 'stromatoporidé',
  stromatoporides: 'stromatoporidé',
  rugosa: 'rugosa',
  récif: 'récif',
  recif: 'récif',
  // foraminifera
  foraminifères: 'foraminifère',
  foraminifere: 'foraminifère',
  foraminiferes: 'foraminifère',
  nummulites: 'nummulite',
  nummulite: 'nummulite',
  nummulitique: 'nummulite',
  orbitolines: 'orbitoline',
  orbitoline: 'orbitoline',
  milioles: 'miliole',
  miliole: 'miliole',
  miliolidés: 'miliolidé',
  miliolides: 'miliolidé',
  alvéolines: 'alvéoline',
  alveolines: 'alvéoline',
  alvéoline: 'alvéoline',
  alveoline: 'alvéoline',
  lituolidés: 'lituolidé',
  lituolides: 'lituolidé',
  orbitoïdes: 'orbitoïde',
  orbitoides: 'orbitoïde',
  orbitolinidés: 'orbitolinidé',
  orbitolinides: 'orbitolinidé',
  discocyclines: 'discocycline',
  discocycline: 'discocycline',
  assilines: 'assiline',
  assiline: 'assiline',
  operculines: 'operculine',
  globigérines: 'globigérine',
  globigerines: 'globigérine',
  globotruncana: 'globotruncana',
  rotalipora: 'rotalipora',
  calpionelles: 'calpionelle',
  praeglobotruncana: 'praeglobotruncana',
  globotruncane: 'globotruncane',
  // trilobites
  ...
  mammifere: 'mammifère',
  mammiferes: 'mammifère',
  vertébrés: 'vertébré',
  vertebre: 'vertébré',
  vertebres: 'vertébré',
  // algae
  algues: 'algue',
  stromatolithes: 'stromatolithe',
  characées: 'characée',
  characees: 'characée',
  dasycladacées: 'dasycladacée',
  dasycladacees: 'dasycladacée',
  lithothamnium: 'lithothamnium',
  microcodium: 'microcodium',
  // bryozoans
  bryozoaires: 'bryozoaire',
  bryozoaire: 'bryozoaire',
  // microfossils
  radiolaires: 'radiolaire',
  ostracodes: 'ostracode',
  conodontes: 'conodonte',
  graptolites: 'graptolite',
  chitinozoaires: 'chitinozoaire',
  acritarches: 'acritarche',
  dinoflagellés: 'dinoflagellé',
  dinoflagelles: 'dinoflagellé',
  spores: 'spore',
  pollen: 'pollen',
  tentaculites: 'tentaculite',
  microflore: 'microflore',
  // annelids
  annélides: 'annélide',
  annelides: 'annélide',
  serpules: 'serpule',
  ...
  bioclastes: 'bioclaste',
  bioclaste: 'bioclaste',
  microfaune: 'microfaune',
  empreintes: 'empreinte',
  encroûtements: 'encroûtement',
  encroutements: 'encroûtement',
  oncolites: 'oncolite',
  oncolithes: 'oncolite',
  oncoïdes: 'oncoïde',
  oncoides: 'oncoïde',
